 ...
 * Date 2019/11/23
 */
public class SettingAlarmActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    @OnClick({R.id.commentackImg, R.id.tv_alarm_time_layout,
            R.id.tv_alarm_type_layout,
            R.id.alarm_type_line, R.id.b30AlarmSaveBtn})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.commentackImg:
                finish();
                break;
            case R.id.tv_alarm_time_layout: //选择时间
                chooseDate();
                break;
            case R.id.tv_alarm_type_layout: //选择日期
