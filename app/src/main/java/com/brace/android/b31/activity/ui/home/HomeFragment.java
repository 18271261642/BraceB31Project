...
public class HomeFragment extends LazyFragment implements OnCurrentCountStepsListener, OnDataCompleteListener {
    ...
    @BindView(R.id.goalStepTv)
    TextView goalStepTv;
    Unbinder unbinder;
    //心率图表
    @BindView(R.id.cusHeartChart)
    BraceCusHeartView cusHeartChart;
    //睡眠图表
    @BindView(R.id.cusSleepView)
    BraceCusSleepView cusSleepView;
    //血压图表
    @BindView(R.id.cusBloodChart)
    ...
    @BindView(R.id.braceCusStepDView)
    BraceCusStepDetailView braceCusStepDView;
    @BindView(R.id.sportMaxNumTv)
    TextView sportMaxNumTv;
    //连接状态
    @BindView(R.id.homeConnStatusTv)
    ...
    private void initViews() {
        ...
        goalStepTv.setText("目标步数: "+goalStep);
...
//                return;
    ...
    private void showHeartView(List<BraceHalfHeartBean> resultHtList) {
        try {
            ...
            lastTimeTv.setText("最近 " + resultHtList.get(resultHtList.size() - 1).getTime().getColck());
    ...
    private void showBloodView(List<BraceHalfBpBean> btList) {
        ...
        try {
            ...
            bloadLastTimeTv.setText("最近 " + btList.get(btList.size() - 1).getTime().getColck());
