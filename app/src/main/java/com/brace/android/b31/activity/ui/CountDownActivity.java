 ...
 * Date 2019/11/23
 */
public class CountDownActivity extends BaseActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    @OnClick({R.id.commentackImg, R.id.startCounDownBtn,
            R.id.oftenDateRel})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.commentackImg:
                finish();
                break;
            case R.id.startCounDownBtn:
                if (!isCountDown) {
                    chooseCoundDownDate(0x00);
                }
                break;
            case R.id.oftenDateRel:
