...
import com.brace.android.b31.activity.TActivity;
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            switch (buttonView.getId()){
                case R.id.b31CheckWearToggleBtn:    //佩戴检测
                    ...
                    break;
                case R.id.b31AutoHeartToggleBtn:    //自动心率检测
                    b31AutoHeartToggleBtn.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31AutoBloadToggleBtn:    //自动血压检测
                    b31AutoBloadToggleBtn.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31AutoBPOxyToggbleBtn:     //自动血氧检测
                    b31AutoBPOxyToggbleBtn.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31SecondToggleBtn:       //秒表
                    b31SecondToggleBtn.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31SwitchFindPhoneToggleBtn:  //查找手机
                ...
                case R.id.b31SwitchDisAlertTogg:    //断连提醒
                    ...
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31SwitchTimeTypeTogg:    //24小时制
                    b31SwitchTimeTypeTogg.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31ScienceToggleBtn:  //科学睡眠
                    b31ScienceToggleBtn.setChecked(isChecked);
                    handler.sendEmptyMessage(0x01);
                    break;
                case R.id.b31SwitchHlepSos: //sos
